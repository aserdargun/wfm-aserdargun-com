...
export const signals: Signal[] = [
  ...
  { id: "signal-cosmos-3-release", discoveryDate: "2026-06-03", eventDate: "2026-06-02", publicationDate: "2026-06-01", affectedEntityIds: ["cosmos-3"], affectedFields: ["availability", "physical-reasoning"], evidenceIds: ["evidence-nvidia-cosmos3"], approved: true },
  { id: "signal-oasis-3-release", discoveryDate: "2026-09-04", eventDate: null, publicationDate: null, affectedEntityIds: ["oasis-3"], affectedFields: ["driving-simulation", "multi-view", "api"], evidenceIds: ["evidence-decart-oasis3"], approved: true },
