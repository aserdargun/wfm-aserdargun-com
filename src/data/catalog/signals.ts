...
export const signals: Signal[] = [
  ...
  { id: "signal-cosmos-1-release", discoveryDate: "2025-01-08", eventDate: "2025-01-07", publicationDate: "2025-01-07", affectedEntityIds: ["cosmos-1"], affectedFields: ["multimodal-generation", "physical-reasoning"], evidenceIds: ["evidence-nvidia-cosmos1"], approved: true },
  { id: "signal-v-jepa-1-release", discoveryDate: "2024-06-12", eventDate: "2024-06-11", publicationDate: "2024-06-11", affectedEntityIds: ["v-jepa-1"], affectedFields: ["latent-prediction", "self-supervised-pretraining"], evidenceIds: ["evidence-meta-vjepa1"], approved: true },
  { id: "signal-oasis-launch", discoveryDate: "2024-10-22", eventDate: "2024-10-21", publicationDate: "2024-10-21", affectedEntityIds: ["oasis"], affectedFields: ["interactive-video", "real-time-inference"], evidenceIds: ["evidence-decart-oasis"], approved: true },
